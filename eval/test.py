import torch
import numpy as np
from src.services.nanovllm_HARD import LLM, SamplingParams
...
def generate_answer(local_dir="datasets", model_path=f"{MODEL_PATH}/Qwen3-4B"):
    ...
    print(f"throughput {outputs[0]["record_throughput"]} tokens/s\n")
