...
OUTPUT_CONFIGS = {
    'LS': {
        'figs_folder': './figs/task_performance',
        'naming_scheme': 'LS',
        'file_prefix': 'LS_task_performance',
        'dpi': 300,
        'format': 'png'
    },
    'LA': {
        'figs_folder': './figs/task_performance',
        'naming_scheme': 'LA',
        'file_prefix': 'LA_task_performance',
        'dpi': 300,
        'format': 'png'
    },
    'HS': {
        'figs_folder': './figs/task_performance',
        'naming_scheme': 'HS',
        'file_prefix': 'HS_task_performance',
        'dpi': 300,
        'format': 'png'
    }, 
    'HA': {
        'figs_folder': './figs/task_performance',
        'naming_scheme': 'HA',
        'file_prefix': 'HA_task_performance',
        'dpi': 300,
        'format': 'png'
    }
}
...
def load_statistics():
    """Load task performance statistics from numpy files."""
...
def main():
    ...
    source = DATA_SOURCE_CONFIG['source']
    print(f"{source} Task Performance Visualization")
    print("=" * 50)
